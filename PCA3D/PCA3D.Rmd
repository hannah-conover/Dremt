...
```{r}
PCAClusters3D <- res$call$X

ggplot(PCAClusters3D,aes(x = Dim.1,
                       y = Dim.2,
                       color = clust
)) + 
...
ggsave(filename = "PCAClusters1-27.png")

ggplot(PCAClusters3D,aes(x = Dim.2,
                       y = Dim.3,
                       color = clust
)) + 
  geom_point(position = "jitter",size = 3)+
...
ggsave(filename = "PCAClusters1-27D23.png")
...
ggsave(filename = "PCAClusters1-27D13.png")
```
