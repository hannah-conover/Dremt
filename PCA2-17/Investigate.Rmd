...
- high values for the variables *Adhesion*, *Proliferation_DMSO*, *CollagenIV* and *CollagenI* (variables are sorted from the strongest).
- low values for the variables *Mean_PXR*, *Survival_20.uM*, *Mean_Ecad*, *Survival_10.uM*, *Mean_Vimentin* and *Proliferation_20.uM* (variables are sorted from the weakest).
...
- low values for the variables *Adhesion*, *Mean_Ecad*, *CollagenIV* and *CollagenI* (variables are sorted from the weakest).

The **cluster 3** is made of individuals such as *4* and *60*. This group is characterized by :

- high values for the variables *Survival_20.uM*, *Proliferation_20.uM*, *Survival_10.uM* and *Fibronectin* (variables are sorted from the strongest).
- low values for the variables *Proliferation_DMSO*, *Mean_Vimentin*, *CollagenI*, *Adhesion*, *Mean_PXR*, *Mean_Ecad* and *CollagenIV* (variables are sorted from the weakest).
...
- low values for the variable *Adhesion*.
