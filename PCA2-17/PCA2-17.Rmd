...
### Adding Callouts
```{r}
PCAClustersLab217 <- datawithcluster217

PCAClustersLab217$Individual <- row.names(PCAClustersLab217)

PCAClustersLab217 <- PCAClustersLab217 %>% mutate(label = case_when(Individual == 172 ~ "A",
                                                      Individual == 209 ~ "B",
                                                      Individual == 64 ~ "C",
                                                      Individual == 95 ~ "D",
                                                      Individual == 190 ~ "E", 
...
PCAClustersLab218 <- PCAClustersLab218 %>% mutate(label = case_when(Individual == 172 ~ "A",
                                                      Individual == 209 ~ "B",
                                                      Individual == 64 ~ "C",
                                                      Individual == 95 ~ "D",
                                                      Individual == 190 ~ "E", 
...
corrplot(res.PCA$quanti.sup$cor, is.corr = FALSE)
...
corrplot(corstufftest, is.corr = FALSE)
