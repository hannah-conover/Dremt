...
DMSOforPCA <-  subset(DMSOdsewithrep, select = c("Metadata_Stiffness","Conditions", "Mean_Green_Norm", "Mean_Orange_Norm", "Mean_Red_Norm"))
...
png("SPcor1corr.png", width = 6, height = 4, units = "in", res = 1200)
corrplot(SPcor1, p.mat = testRes1$p, sig.level = 0.05, type = "upper", order = "hclust", col = brewer.pal(n=8, name = "RdYlBu"), diag = FALSE, addCoef.col = 'black')
dev.off()

png("SPcor25corr.png", width = 6, height = 4, units = "in", res = 1200)
corrplot(SPcor25, p.mat = testRes25$p, sig.level = 0.05, type = "upper", order = "hclust", col = brewer.pal(n=8, name = "RdYlBu"), diag = FALSE, addCoef.col = 'black')
dev.off()
...
ggsave("Zscorecomparison.png", width = 10, height = 5)
