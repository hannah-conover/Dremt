...
ggsave("Vim Intx/Galectin3RatiovsECMvsStiffness.png", width = 10, height = 5)
```
...
SP1 <- SP1[,c("Mean_Orange_Norm", "Mean_Red_Norm", "Mean_Green_Norm")]
SP25 <- SP25[,c("Mean_Orange_Norm", "Mean_Red_Norm", "Mean_Green_Norm")]
# colnames(SP1) <- c("Survival", "Vimentin", "Ecad", "PXR")
# colnames(SP25) <- c("Survival", "Vimentin", "Ecad", "PXR")
colnames(SP1) <- c( "Vimentin", "Ecad", "PXR")
colnames(SP25) <- c("Vimentin", "Ecad", "PXR")
```
